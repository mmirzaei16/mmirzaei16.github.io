...
<br>
<br>
<h3>Mechanical analysis & design & manufacturing</h3>
<br>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_2.JPG' | relative_url }}" width="200" height="350" />
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_3.JPG' | relative_url }}" width="200" height="350"/>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_4.JPG' | relative_url }}" width="200" height="350"/>
    </div> 
</div>
<!-- <div class="caption">
...
<br>
<h4>2) A 4 DOF Arm with 2 DOF Gripper</h4>
<p align="justify">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_6.JPG' | relative_url }}" width="200" height="125"/>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_7.JPG' | relative_url }}" width="200" height="125"/>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_8.JPG' | relative_url }}" width="200" height="125"/>
    </div> 
</div>
<br>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_9.JPG' | relative_url }}" width="300" height="220"/>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_10.JPG' | relative_url }}" width="300" height="220"/>
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        <img class="img-fluid rounded z-depth-1" src="{{ '/assets/img/andrew_12.JPG' | relative_url }}" style="width:60%" />
    </div>
</div>
<br>
<br>
